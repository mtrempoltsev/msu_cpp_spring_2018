...
#ifndef ГЛАВНОЕ_ЗДАНИЕ_ЗАМОК__H
#define ГЛАВНОЕ_ЗДАНИЕ_ЗАМОК__H
#include "Здание.h"

#include <string>

/**
  * class Главное_здание_замок_
  * 
  */

class Главное_здание_замок_ : public Здание
{
public:
   ...
   * Empty Constructor
   */
  Главное_здание_замок_ ();

  /**
   * Empty Destructor
   */
  virtual ~Главное_здание_замок_ ();
